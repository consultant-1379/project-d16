...
.dark .ranger-container:hover .ranger-progress {
  background: #0084f0;
}
.dark .ranger-container:hover .ranger-handle {
  background: #0084f0;
}
...
.dark .ranger-container.ranger-multiple .ranger-input:focus + .ranger-track .ranger-handle {
  outline: none;
}
.dark .ranger-container.ranger-multiple .ranger-handle:focus,
.dark .ranger-container.ranger-multiple .ranger-handle:active {
  outline: 1px solid #8e45b0;
  outline-offset: 1px;
}
...
.light .ranger-container:hover .ranger-progress {
  background: #0084f0;
}
.light .ranger-container:hover .ranger-handle {
  background: #0084f0;
}
...
.light .ranger-container.ranger-multiple .ranger-input:focus + .ranger-track .ranger-handle {
  outline: none;
}
.light .ranger-container.ranger-multiple .ranger-handle:focus,
.light .ranger-container.ranger-multiple .ranger-handle:active {
  outline: 1px solid #a56ebe;
  outline-offset: 1px;
}
