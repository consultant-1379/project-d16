...
.dark label input[type="file"]:focus ~ .btn {
  outline: 1px solid #8e45b0;
  outline-offset: 1px;
}
.dark label input[type="file"]:disabled ~ .btn {
  opacity: 0.4;
  pointer-events: none;
  cursor: default;
}
...
.light label input[type="file"]:focus ~ .btn {
  outline: 1px solid #a56ebe;
  outline-offset: 1px;
}
.light label input[type="file"]:disabled ~ .btn {
  opacity: 0.4;
  pointer-events: none;
  cursor: default;
}
