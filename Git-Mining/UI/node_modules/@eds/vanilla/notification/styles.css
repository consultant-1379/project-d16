...
.dark .notification .top-row .title .icon {
...
.dark .notification .top-row .icon.close::before {
  position: absolute;
  top: -3px;
  left: -1px;
}
...
.light .notification .top-row .title .icon {
  vertical-align: unset;
  margin-right: 6px;
}
...
.light .notification .top-row .icon.close::before {
  position: absolute;
  top: -3px;
  left: -1px;
}
