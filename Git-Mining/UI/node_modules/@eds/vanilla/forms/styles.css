...
.light .eds-form .form-header {
  margin-bottom: 32px;
}
.light .eds-form .form-body {
  max-width: 834px;
  margin: 0 auto 32px;
}
.light .eds-form .form-body .column {
  border-right: 1px solid #878787;
}
.light .eds-form .form-body .column:not(:last-child) {
  padding-right: 16px;
}
.light .eds-form .form-body .column:not(:first-child) {
  padding-left: 16px;
}
.light .eds-form .form-group:not(:last-child) {
  margin-bottom: 32px;
}
.light .eds-form .form-group .form-group-title {
  font-size: 14px;
  font-weight: 700;
  line-height: 1.5em;
}
.light .eds-form .form-element {
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
  -ms-flex-wrap: wrap;
...
.light .eds-form .form-element:not(:first-child) {
  margin-top: 16px;
}
.light .eds-form .form-element > div {
  width: 100%;
}
.light .eds-form .form-element > .select {
  max-width: 100%;
}
.light .eds-form .title {
  font-size: 16px;
...
.light .eds-form label {
  width: 100%;
  max-width: 320px;
}
.light .eds-form .ranger-container,
.light .eds-form .select,
.light .eds-form input,
.light .eds-form textarea {
  width: 100%;
}
.light .eds-form .ranger-container[type="number"],
.light .eds-form .select[type="number"],
.light .eds-form input[type="number"],
.light .eds-form textarea[type="number"] {
  min-width: 80px;
}
.light .eds-form .ranger-container[type="password"],
.light .eds-form .select[type="password"],
.light .eds-form input[type="password"],
.light .eds-form textarea[type="password"] {
  max-width: 160px;
}
.light .eds-form .form-footer {
  text-align: right;
  max-width: 834px;
  margin: 0 auto;
}
@media (min-width: 769px) and (max-width: 1199px) {
  ...
  .light .eds-form .form-body .column label,
  .light .eds-form .form-body .column .form-element > div,
  .light .eds-form .form-body .column .ranger-container,
  .light .eds-form .form-body .column .select,
  .light .eds-form .form-body .column input,
  .light .eds-form .form-body .column textarea {
    width: 100%;
  }
}
@media (max-width: 768px) {
  ...
  .light .eds-form .form-body .column .form-element {
    -webkit-box-orient: horizontal;
    -webkit-box-direction: normal;
        -ms-flex-direction: row;
            flex-direction: row;
  }
  .light .eds-form .form-body .column .form-element label {
    width: 33%;
  }
  .light .eds-form .form-body .column .form-element > div,
  .light .eds-form .form-body .column .form-element > .ranger-container,
  .light .eds-form .form-body .column .form-element > .select,
  .light .eds-form .form-body .column .form-element > input,
  .light .eds-form .form-body .column .form-element > textarea {
    width: calc(67% - 8px);
    margin-left: 8px;
    margin-right: 0;
  }
...
.dark .eds-form .form-header {
  margin-bottom: 32px;
}
.dark .eds-form .form-body {
  max-width: 834px;
  margin: 0 auto 32px;
}
.dark .eds-form .form-body .column {
  border-right: 1px solid #878787;
}
.dark .eds-form .form-body .column:not(:last-child) {
  padding-right: 16px;
}
.dark .eds-form .form-body .column:not(:first-child) {
  padding-left: 16px;
}
.dark .eds-form .form-group:not(:last-child) {
  margin-bottom: 32px;
}
.dark .eds-form .form-group .form-group-title {
  font-size: 14px;
  font-weight: 500;
  line-height: 1.5em;
}
.dark .eds-form .form-element {
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
  -ms-flex-wrap: wrap;
...
.dark .eds-form .form-element:not(:first-child) {
  margin-top: 16px;
}
.dark .eds-form .form-element > div {
  width: 100%;
}
.dark .eds-form .form-element > .select {
  max-width: 100%;
}
.dark .eds-form .title {
  font-size: 16px;
...
.dark .eds-form .ranger-container,
.dark .eds-form .select,
.dark .eds-form input,
.dark .eds-form textarea {
  width: 100%;
}
.dark .eds-form .ranger-container[type="number"],
.dark .eds-form .select[type="number"],
.dark .eds-form input[type="number"],
.dark .eds-form textarea[type="number"] {
  min-width: 80px;
}
.dark .eds-form .ranger-container[type="password"],
.dark .eds-form .select[type="password"],
.dark .eds-form input[type="password"],
.dark .eds-form textarea[type="password"] {
  max-width: 160px;
}
.dark .eds-form .form-footer {
  text-align: right;
  max-width: 834px;
  margin: 0 auto;
}
@media (min-width: 769px) and (max-width: 1199px) {
  ...
  .dark .eds-form .form-body .column label,
  .dark .eds-form .form-body .column .form-element > div,
  .dark .eds-form .form-body .column .ranger-container,
  .dark .eds-form .form-body .column .select,
  .dark .eds-form .form-body .column input,
  .dark .eds-form .form-body .column textarea {
    width: 100%;
  }
}
@media (max-width: 768px) {
  ...
  .dark .eds-form .form-body .column .form-element {
    -webkit-box-orient: horizontal;
    -webkit-box-direction: normal;
        -ms-flex-direction: row;
            flex-direction: row;
  }
  .dark .eds-form .form-body .column .form-element label {
    width: 33%;
  }
  .dark .eds-form .form-body .column .form-element > div,
  .dark .eds-form .form-body .column .form-element > .ranger-container,
  .dark .eds-form .form-body .column .form-element > .select,
  .dark .eds-form .form-body .column .form-element > input,
  .dark .eds-form .form-body .column .form-element > textarea {
    width: calc(67% - 8px);
    margin-left: 8px;
    margin-right: 0;
  }
