...
.light .wizard-steps .steps .step.completed .description {
  color: #242424;
}
...
.light .wizard-steps .steps .step.completed-last.current .nextbar {
  background: #878787;
}
.light .wizard-steps .steps .step.completed.current ~ .completed-last .nextbar {
  background: #878787;
}
...
.dark .wizard-steps .steps .step.completed .description {
  color: #f2f2f2;
}
...
.dark .wizard-steps .steps .step.completed-last.current .nextbar {
  background: #767676;
}
.dark .wizard-steps .steps .step.completed.current ~ .completed-last .nextbar {
  background: #767676;
}
