...
.light .calendar table.body tbody tr td.disabled {
  opacity: 0.4;
  pointer-events: none;
  cursor: default;
}
...
.light .datepicker input[name='datepicker']:disabled + .suffix {
  opacity: 0.4;
  pointer-events: none;
  cursor: default;
}
...
.dark .calendar table.body tbody tr td.disabled {
  opacity: 0.4;
  pointer-events: none;
  cursor: default;
}
...
.dark .datepicker input[name='datepicker']:disabled + .suffix {
  opacity: 0.4;
  pointer-events: none;
  cursor: default;
}
