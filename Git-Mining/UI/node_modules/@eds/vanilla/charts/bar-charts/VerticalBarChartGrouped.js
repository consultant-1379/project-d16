...
export class VerticalBarChartGrouped {
  ...
  draw(data) {
    ...
    const bars = barGroupsEnter
      ...
      .selectAll('.bar')
      .data(
        (d, i) => this.data.series.map(serie => ({ key: serie.name, value: serie.values[i] })),
        d => d.key
      );
    ...
    bars
      ...
      .attr('x2', d => x1(d.key))
      .attr('y1', 0)
      .attr('y2', d => isNaN(d.value) ? 0 : y(d.value) - y(0));
