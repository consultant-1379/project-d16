...
.light input[type="radio"]:focus + label::before {
  outline: 1px solid #a56ebe;
  outline-offset: 1px;
}
...
.light input[type="radio"] + label:empty {
  line-height: 1;
}
...
.light input[type="radio"]:checked:hover + label::before {
  content: " ";
  display: inline-block;
  width: 16px;
  height: 16px;
  vertical-align: text-top;
  background: url("data:image/svg+xml;base64,") no-repeat 100% center;
  margin-right: 4px;
}
...
.light input[type="radio"]:not(:checked) + label::before {
  content: " ";
  display: inline-block;
  width: 16px;
  height: 16px;
  vertical-align: text-top;
  background: url("data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxNiIgaGVpZ2h0PSIxNiIgdmlld0JveD0iMCAwIDE2IDE2Ij4KICAgIDxjaXJjbGUgY3g9IjgiIGN5PSI4IiByPSI1LjUiIGZpbGw9IiNGRkYiIGZpbGwtcnVsZT0iZXZlbm9kZCIgc3Ryb2tlPSIjODc4Nzg3Ii8+Cjwvc3ZnPgo=") no-repeat 100% center;
  margin-right: 4px;
}
.light input[type="radio"]:not(:checked):hover + label::before {
  content: " ";
  display: inline-block;
  width: 16px;
  height: 16px;
  vertical-align: text-top;
  background: url("data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxNiIgaGVpZ2h0PSIxNiIgdmlld0JveD0iMCAwIDE2IDE2Ij4KICAgIDxjaXJjbGUgY3g9IjgiIGN5PSI4IiByPSI1LjUiIGZpbGw9IiNGRkYiIGZpbGwtcnVsZT0iZXZlbm9kZCIgc3Ryb2tlPSIjNkE2QTZBIi8+Cjwvc3ZnPgo=") no-repeat 100% center;
  margin-right: 4px;
}
...
.dark input[type="radio"] + label:empty {
  line-height: 1;
}
...
.dark input[type="radio"]:checked:hover + label::before {
  content: " ";
  display: inline-block;
  width: 16px;
  height: 16px;
