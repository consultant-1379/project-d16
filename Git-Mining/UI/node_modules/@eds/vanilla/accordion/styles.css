...
.light .accordion .accordion-list {
...
.light .accordion .accordion-item > .title {
  font-size: 14px;
  line-height: 1.5;
  margin: 0;
...
.light .accordion .accordion-item > .title:hover {
  background: #dcdcdc;
}
.light .accordion .accordion-item > .title::before {
  content: "\e922";
  padding: 0 8px;
  font-family: "Ericsson Icons";
  font-size: 16px;
...
.light .accordion .accordion-item > .content {
  display: none;
  padding: 0 24px 16px;
}
.light .accordion .accordion-item > .content.no-inset {
  padding: 0 8px 16px;
}
.light .accordion .accordion-item:nth-child(n + 1) {
  margin: -1px 0 0;
}
.light .accordion .accordion-item:focus {
  outline: 1px solid #a56ebe;
}
.light .accordion .accordion-item.opened > .title {
  font-weight: 400;
}
.light .accordion .accordion-item.opened > .title::before {
  content: "\e925";
}
.light .accordion .accordion-item.opened > .content {
  display: block;
}
.light .accordion.lines .accordion-item {
...
.dark .accordion .accordion-item > .title {
  font-size: 14px;
  line-height: 1.5;
  margin: 0;
  padding: 9px 8px 10px;
...
.dark .accordion .accordion-item > .title:hover {
  background: #4e4e4e;
}
.dark .accordion .accordion-item > .title::before {
  content: "\e922";
  padding: 0 8px;
  font-family: "Ericsson Icons";
  font-size: 16px;
...
.dark .accordion .accordion-item > .content {
  display: none;
  padding: 0 24px 16px;
}
.dark .accordion .accordion-item > .content.no-inset {
  padding: 0 8px 16px;
}
.dark .accordion .accordion-item:nth-child(n + 1) {
  margin: -1px 0 0;
}
.dark .accordion .accordion-item:focus {
  outline: 1px solid #8e45b0;
}
.dark .accordion .accordion-item.opened > .title {
  font-weight: 400;
}
.dark .accordion .accordion-item.opened > .title::before {
  content: "\e925";
}
.dark .accordion .accordion-item.opened > .content {
  display: block;
}
.dark .accordion.lines .accordion-item {
