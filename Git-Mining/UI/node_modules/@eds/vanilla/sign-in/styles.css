...
.dark .signin input[disabled] + label,
.dark .signin textarea[disabled] + label {
  opacity: 0.4;
  pointer-events: none;
  cursor: default;
}
.dark .signin input[disabled] + .reveal,
.dark .signin textarea[disabled] + .reveal {
  pointer-events: none;
}
.dark .signin label {
  color: #f2f2f2;
...
.dark .signin form .field input:not([type="checkbox"]):invalid:not(:focus).field-filled,
.dark .signin form .field input:not([type="checkbox"]).invalid {
  border-left: solid 3px #dc2d37 !important;
}
.dark .signin form .field input:not([type="checkbox"]):invalid:not(:focus).field-filled:hover,
.dark .signin form .field input:not([type="checkbox"]).invalid:hover {
  border-left-color: #dc2d37;
}
.dark .signin form .field input:not([type="checkbox"]):invalid:not(:focus).field-filled ~ .hint,
...
.dark .signin form .field input:not([type="checkbox"]).field-filled + label {
  -webkit-transform: translate(8px, -38px);
...
.dark .signin form .field input#password:-webkit-autofill {
  -webkit-box-shadow: 0 0 0 50px #0a0a0a inset;
          box-shadow: 0 0 0 50px #0a0a0a inset;
...
.light .signin input[disabled] + label,
.light .signin textarea[disabled] + label {
  opacity: 0.4;
  pointer-events: none;
  cursor: default;
}
.light .signin input[disabled] + .reveal,
.light .signin textarea[disabled] + .reveal {
  pointer-events: none;
}
.light .signin label {
  color: #f2f2f2;
...
.light .signin form .field input:not([type="checkbox"]):invalid:not(:focus).field-filled,
.light .signin form .field input:not([type="checkbox"]).invalid {
  border-left: solid 3px #dc2d37 !important;
}
.light .signin form .field input:not([type="checkbox"]):invalid:not(:focus).field-filled:hover,
.light .signin form .field input:not([type="checkbox"]).invalid:hover {
  border-left-color: #dc2d37;
}
.light .signin form .field input:not([type="checkbox"]):invalid:not(:focus).field-filled ~ .hint,
...
.light .signin form .field input:not([type="checkbox"]).field-filled + label {
  -webkit-transform: translate(8px, -38px);
          transform: translate(8px, -38px);
  font-size: 12px;
  opacity: 0.7;
