...
.dark input[type="checkbox"] + label:empty {
  line-height: 1;
}
.dark input[type="checkbox"] + label:empty::before {
  margin-right: 0;
}
.dark input[type="checkbox"]:hover + label::before {
  content: " ";
  display: inline-block;
  width: 16px;
  height: 16px;
...
.dark input[type="checkbox"]:checked:hover + label::before {
  content: " ";
  display: inline-block;
  width: 16px;
  height: 16px;
...
.dark input[type="checkbox"]:indeterminate + label::before {
  content: " ";
  display: inline-block;
  width: 16px;
  height: 16px;
...
.dark input[type="checkbox"]:indeterminate:hover + label::before {
  content: " ";
  display: inline-block;
  width: 16px;
  height: 16px;
...
.dark .checkbox-group .validation-msg {
  display: none;
  margin-top: 8px;
  font-size: 12px;
  line-height: 14px;
...
.light input[type="checkbox"] + label:empty {
  line-height: 1;
}
.light input[type="checkbox"] + label:empty::before {
  margin-right: 0;
}
.light input[type="checkbox"]:hover + label::before {
  content: " ";
  display: inline-block;
  width: 16px;
  height: 16px;
...
.light input[type="checkbox"]:disabled + label {
  opacity: 0.4;
  pointer-events: none;
  cursor: default;
}
.light input[type="checkbox"]:focus + label::before {
  outline: 1px solid #a56ebe;
  outline-offset: 1px;
}
...
.light input[type="checkbox"]:checked:hover + label::before {
  content: " ";
  display: inline-block;
  width: 16px;
  height: 16px;
...
.light input[type="checkbox"]:indeterminate + label::before {
  content: " ";
  display: inline-block;
  width: 16px;
  height: 16px;
...
.light input[type="checkbox"]:indeterminate:hover + label::before {
  content: " ";
  display: inline-block;
  width: 16px;
  height: 16px;
...
.light .checkbox-group .validation-msg {
  display: none;
  margin-top: 8px;
  font-size: 12px;
  line-height: 14px;
